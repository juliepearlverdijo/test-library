...
config.set({
  "singleRun": true,
  "autoWatch": false,
  "basePath": "C:\\Users\\AnthonyPC2\\IdeaProjects\\test-library\\build\\js\\packages\\test-library-js-legacy-test\\node_modules",
  "files": [
    "C:\\Users\\AnthonyPC2\\IdeaProjects\\test-library\\build\\js\\packages\\test-library-js-legacy-test\\adapter-browser.js"
  ],
  "frameworks": [
    "mocha"
  ],
...
;(function(config) {
    ...
    const handler = (percentage, message, ...args) => {
        ...
        msg = msg.replace(new RegExp("C:\\Users\\AnthonyPC2\\IdeaProjects\\test-library\\build\\js", 'g'), '');;
        console.log(msg);
    };
